...
require (
	github.com/containifyci/engine-ci v0.20.2
	github.com/containifyci/engine-ci/protos2 v0.12.7 // indirect
)
...
require (
	...
	github.com/letsencrypt/boulder v0.0.0-20250418191831-e8eddc0d5006 // indirect
